========================================================================
    KONSOLENANWENDUNG: ComputationalGeometry-Projektübersicht
========================================================================

Diese ComputationalGeometry-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre ComputationalGeometry-Anwendung besteht.


ComputationalGeometry.vcxproj
...
ComputationalGeometry.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "ComputationalGeometry.pch und eine 
